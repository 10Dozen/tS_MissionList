...
public class BriefingFileReaderTrimTest {
    ...
    public BriefingFileReaderTrimTest(String line, String expectedTrimmedLine) {
        this.line = line;
    ...
    public void trimLineTest() {
        String trimmedLine = BFR.trimQuotesFromLine(line);
